...
from glamcheck.utils import TokenType
...
class JwtService:
    ...
    def encode_access_token(self, sub: str) -> str:
        return self.__encode_token(sub=sub, token_type=TokenType.ACCESS)
    ...
    def __encode_token(self, sub: str, token_type: TokenType):
        bound = self.__logger.bind(sub=sub, token_type=token_type)
